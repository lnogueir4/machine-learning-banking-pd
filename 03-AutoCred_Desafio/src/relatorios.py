...
def paragrafos(d: dict, est: pd.DataFrame) -> dict[str, str]:
    ...
    return {
        ...
        "modelo": (
            "*Out-of-time* é o teste no futuro: o modelo aprende em 2022-2023 e é medido em "
            "2024, uma safra que não existia quando ele foi treinado — é o que acontece em "
            "produção, e é o que uma amostra aleatória esconderia ao misturar 2024 no treino. "
            "A Random Forest empatou nesse teste (0,735), mas marcava 0,921 no treino — queda "
